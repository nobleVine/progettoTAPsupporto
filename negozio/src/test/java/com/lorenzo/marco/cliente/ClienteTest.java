...
public class ClienteTest {
	...
	public void testRichiestaRegistrazioneRiuscita() throws UnknownHostException {
		this.cliente = creazioneCliente("Marco", "Vignini", "", "", database);
		when(database.registrazioneCliente(cliente.getNome(), cliente.getCognome())).thenReturn("Registrazione riuscita");
	...
	public void testRichiestaRegistrazioneNonRiuscita() throws UnknownHostException {
		this.cliente = creazioneCliente("Marco", "Vignini", "", "", database);
		when(database.registrazioneCliente(cliente.getNome(), cliente.getCognome())).thenReturn("Registrazione non riuscita");
